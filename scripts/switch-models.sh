...
# ── OPENAI ──
MODEL_NORMAL[openai_ultra_budget]="openai/gpt-5.6-luna"
MODEL_BB[openai_ultra_budget]="openai/gpt-5.6-luna"

MODEL_NORMAL[openai_value]="openai/gpt-5.6-luna"
MODEL_BB[openai_value]="openai/gpt-5.6-luna"

MODEL_NORMAL[openai_standard]="openai/gpt-5.6-terra"
MODEL_BB[openai_standard]="openai/gpt-5.6-terra"

MODEL_NORMAL[openai_premium]="openai/gpt-5.6-sol"
MODEL_BB[openai_premium]="openai/gpt-5.6-sol"

# ── OPENROUTER ──
MODEL_NORMAL[bifrost_ultra_budget]="bifrost/code"
MODEL_BB[bifrost_ultra_budget]="bifrost/code"

MODEL_NORMAL[bifrost_value]="bifrost/code"
MODEL_BB[bifrost_value]="bifrost/code"

MODEL_NORMAL[bifrost_standard]="bifrost/code"
MODEL_BB[bifrost_standard]="bifrost/code"

MODEL_NORMAL[bifrost_premium]="bifrost/code"
MODEL_BB[bifrost_premium]="bifrost/code"
