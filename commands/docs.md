...
1. **Explore** — read README, source tree, existing `docs/`, changelogs, contributing guides. If an issue is referenced (e.g., `#42`), load `issue-tracking` skill and read the issue for documentation requirements.
