...
3. **Consult** — dispatch subagents for specialized input:
   - @minion-architect or @minion-architect-lead for architecture-level questions
   - @minion-tech-lead for implementation approach feasibility
   - @minion-developer-backend / @minion-developer-frontend for technology-specific expertise
   - @minion-devops for infrastructure/deployment questions
