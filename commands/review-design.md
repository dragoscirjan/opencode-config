...
2. **Dispatch reviewers** — based on the document type:
   - **Design overview** → @minion-archimedes-architect + @minion-odysseus-tech-lead review
   - **HLD** → @minion-odysseus-tech-lead + relevant dev(s) review
   - **LLD** → relevant dev(s) review (not @minion-odysseus-tech-lead if they authored it)
