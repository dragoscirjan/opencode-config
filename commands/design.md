...
1. **Assess** — determine scope. If `$ARGUMENTS` references a spec (`.specs/`), read it for context. If it references an issue (`#N`), load `issue-tracking` skill and read the issue.
