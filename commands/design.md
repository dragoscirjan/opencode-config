...
4. **Execute** — solo: analyze and present architecture in chat. Team: orchestrate @minion-architect-lead (design overview) → @minion-architect (HLDs) → @minion-tech-lead (LLDs) with review rounds.
