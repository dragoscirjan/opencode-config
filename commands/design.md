...
4. **Execute** — solo: analyze and present architecture in chat. Team: orchestrate @lead-architect (design overview) → @architect (HLDs) → @tech-lead (LLDs) with review rounds.
