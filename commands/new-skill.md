...
3. **Write** — create `skills/<name>/SKILL.md` with clear sections: purpose, rules, templates/conventions, examples. Use the same style as existing skills (wire-protocol, wire-design, etc.).
