...
4. **Fix** — apply the minimal change to resolve the root cause. Load `clean-code` and appropriate language skill.
5. **Test** — ensure the failing test now passes. Run the full test suite — no regressions.
6. **Review** — for non-trivial fixes, dispatch @reviewer. Address feedback.
