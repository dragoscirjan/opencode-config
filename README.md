...
|-------|--------|------|-------|------------|
| **Lead Architect** | Both | Design overviews, scope review | `claude-opus-4.6` | Athena, Hermes |
| **Architect** | Software | HLDs — what, not how | `claude-sonnet-4.6` | Athena |
| **Freya** | Game | GDDs — game vision, mechanics, art direction | `claude-sonnet-4.6` | Athena |
| **Tech Lead** | Software | LLDs, task breakdowns, design reviews | `claude-opus-4.6` | Athena, Hephaestus |
| **Developer Backend** | Software | Backend code, APIs, data layers, tests | `claude-sonnet-4.6` | Hephaestus |
| **Developer Frontend** | Software | Frontend code, UI components, tests | `claude-sonnet-4.6` | Hephaestus |
| **DevOps** | Software | Infrastructure, CI/CD, deployment | `claude-sonnet-4.6` | Hephaestus |
| **Reviewer** | Software | Code review — quality, security, correctness | `claude-opus-4.6` | Hephaestus |
...
| Script | Purpose |
|--------|---------|
| `scripts/switch-models.sh` | Bulk model swap across all agent files. Supports keywords: `copilot`, `anthropic`, `openai`, `openrouter`, `free`. Strong tier (opus) for `minion-lead-architect`, `minion-tech-lead`, `minion-reviewer`, Gea, Odin. Fast tier (sonnet) for all others. |
